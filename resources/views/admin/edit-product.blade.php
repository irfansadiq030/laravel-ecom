    ...
    <div class="nk-block-head nk-block-head-lg wide-sm">
        <div class="nk-block-head-content">
            ...
            <div class="nk-block-des">
                <p class="lead">Edit Product to Organize and Categorize Your Content</p>
            </div>
        </div>
    </div><!-- .nk-block -->
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <div class="form-control-wrap">
                                        <input value="{{ $product_data->title }}" name="product_title" type="text" class="form-control" id="category_title">
                                        <input value="{{ $product_data->id }}" name="product_id" type="hidden" class="form-control" id="product_id">
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="cat_slug">Slug</label>
                                    <div class="form-control-wrap">
                                        <input value="{{ $product_data->slug }}" name="slug" type="text" class="form-control" id="cat_slug">
                                    </div>
                                </div>
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea name="description" type="text" class="form-control" id="product_desc" rows="1"> {{ $product_data->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="size" class="form-select select2-hidden-accessible" data-select2-id="5" tabindex="-1" aria-hidden="true">
                                                <option {{ $product_data->size === 1 ?'selected' :'' }} value="1" data-select1-id="5">Medium</option>
                                                <option {{ $product_data->size === 0 ?'selected' :'' }} value="0" data-select1-id="18">Large</option>
                                                <option {{ $product_data->size === 2 ?'selected' :'' }} value="2" data-select1-id="2">Small</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="color" class="form-select select2-hidden-accessible" data-select2-id="6" tabindex="-1" aria-hidden="true">
                                                <option {{ $product_data->color === 'red' ?'selected' :'' }} value="red">Red</option>
                                                <option {{ $product_data->color === 'green' ?'selected' :'' }} value="green">Green</option>
                                                <option {{ $product_data->color === 'blue' ?'selected' :'' }} value="blue">Blue</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        ...
                                        <input value="{{ $product_data->selling_price }}" name="selling_price" type="number" class="form-control" id="selling_price">
                                    </div>
                                </div>
                                <!-- <div class="form-control-wrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select id="category" name="category" class="form-select select2-hidden-accessible" data-select2-id="12" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option {{ $product_data->category === $category->id ?'selected' :'' }} value="{{ $category->id }}">{{ $category->title }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select id="subcategory" name="sub_category" class="form-select select2-hidden-accessible" data-select2-id="120" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option {{ $subcategory->id == $product_data->sub_category ? 'selected' : '' }} value="{{ $subcategory->id }}">{{ $subcategory->title }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
