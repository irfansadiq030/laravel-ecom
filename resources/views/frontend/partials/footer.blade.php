 <footer class="ec-footer">
                                ...
                                <div class="ec-footer-widget">
                                    ...
                                    <div class="ec-footer-links">
                                        <ul class="align-items-center">
                                            ...
                                            <li class="ec-footer-link ec-foo-mail"><span><i class="fi fi-rr-envelope"></i></span><a href="mailto:support@demo.email">support@demo.email</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="ec-nav-toolbar">
        <div class="container">
            <div class="ec-nav-panel">
                ...
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><i class="fi-rr-shopping-basket"></i><span class="ec-cart-noti ec-header-count cart-count-lable">3</span></a>
                </div>
                <div class="ec-nav-panel-icons">
    ...
    <!-- Vendor JS -->
    <script src="frontend_assets/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="frontend_assets/js/vendor/popper.min.js"></script>
    <script src="frontend_assets/js/vendor/bootstrap.min.js"></script>
    <script src="frontend_assets/js/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="frontend_assets/js/vendor/modernizr-3.11.2.min.js"></script>

    <!--Plugins JS-->

    <script src="frontend_assets/js/plugins/jquery.sticky-sidebar.js"></script>
    <script src="frontend_assets/js/plugins/swiper-bundle.min.js"></script>
    <script src="frontend_assets/js/plugins/countdownTimer.min.js"></script>
    <script src="frontend_assets/js/plugins/nouislider.js"></script>
    <script src="frontend_assets/js/plugins/scrollup.js"></script>
    <script src="frontend_assets/js/plugins/jquery.zoom.min.js"></script>
    <script src="frontend_assets/js/plugins/slick.min.js"></script>
    <script src="frontend_assets/js/plugins/owl.carousel.min.js"></script>
    <script src="frontend_assets/js/plugins/infiniteslidev2.js"></script>
    <script src="frontend_assets/js/plugins/click-to-call.js"></script>

    <!-- Main Js -->
    <script src="frontend_assets/js/vendor/index.js"></script>
    <script src="frontend_assets/js/demo-8.js"></script>
</body>
